...
class EmbeddingService:
    ...
    def store_embedding(self, item_type: str, item_id: str, text: str) -> bool:
        ...
        try:
            ...
            cursor.execute('''
                ...
                (item_type, item_id, vector_blob, timestamp)
                VALUES (?, ?, ?, ?)
            ''', (item_type, item_id, vector_blob, datetime.now().isoformat()))
    ...
    def search_similar_items(self, query_text: str = None, summary_id: str = None, top_k: int = 3) -> List[Dict[str, Any]]:
